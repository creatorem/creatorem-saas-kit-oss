...
import { OrganizationRolesPage, OrganizationSettingMedia, UserInvitationsPage } from '../../components';
import { OrganizationMembersPage } from '../../pages';
                            ...
                            settings: [
                                {
                                    ...
                                    header: (
                                        <>
                                            ...
                                            <Muted>{t('index.organizationInfo.titleDescription')}</Muted>
                                        </>
                                    ),
                                    submitButton: {
                                ...
                                },
                                {
                                    ...
                                    header: (
                                        <>
                                            ...
                                            <Muted>{t('index.additionalSettings.description')}</Muted>
                                        </>
                                    ),
                                    submitButton: {
                                            ...
                                            render: (
                                                <div className="space-y-4">
                                                    <div className="flex flex-col gap-2">
                                                        ...
                                                        <Muted>{t('members.content.description')}</Muted>
                                                    </div>
                                            ...
                                            render: (
                                                <div className="space-y-4">
                                                    <div className="flex flex-col gap-2">
                                                        ...
                                                        <Muted>{t('roles.content.description')}</Muted>
                                                    </div>
                                                      ...
                                                      render: (
                                                          <div className="space-y-4">
                                                              <div className="flex flex-col gap-2">
                                                                  ...
                                                                  <Muted>{t('invitations.content.description')}</Muted>
                                                              </div>
                                                              <UserInvitationsPage
                                                                  clientTrpc={
