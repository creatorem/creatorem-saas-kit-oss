...
export const updateSettingsFormAction = async (
    { settingKeys, values }: z.infer<typeof updateSettingsFormSchema>,
    { db }: { db: AppClient },
) => {
    const fullSchemaConfig = applyServerFilter('server_get_settings_schema', { schema: {} as SettingSchemaMap<string> });
