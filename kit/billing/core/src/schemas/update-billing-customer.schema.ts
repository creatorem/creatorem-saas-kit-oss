...
export const updateBillingCustomerSchema = z.object({
    ...
    name: z
        ...
        .trim()
        .max(512, 'Maximum 512 characters allowed for name.')
        .optional()
        .or(z.literal('')),
    line1: z
        .string({
    ...
    country: z
        ...
        .toUpperCase()
        .refine(
            (val) => !val || billingAddressCountries.some((country) => country.code === val),
...
export type UpdateBillingCustomerFormSchema = z.infer<typeof updateBillingCustomerSchema>;
