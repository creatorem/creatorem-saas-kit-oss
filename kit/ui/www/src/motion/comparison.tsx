/**
 * Component from the shadcn.io website.
 */
'use client';
...
export const Comparison = ({
    ...
    return (
        <ImageComparisonContext.Provider
            value={{ sliderPosition, setSliderPosition, motionSliderPosition, mode, portalId }}
        >
...
export const ComparisonHandle = ({ className, ...props }: ComparisonHandleProps) => {
    const { motionSliderPosition, mode, portalId } = useImageComparisonContext();
    ...
    return (
        <>
            <motion.div
                ...
                {...props}
            >
                <div className="bg-background absolute left-1/2 h-full w-1 -translate-x-1/2 border-x" />
            </motion.div>
            ...
            {mode === 'drag' && (
                <Portal containerID={portalId}>
                    ...
                    >
                        <div className="p-18">
                            <div className="bg-background z-50 flex items-center justify-center rounded-xs border px-0.5 py-1">
