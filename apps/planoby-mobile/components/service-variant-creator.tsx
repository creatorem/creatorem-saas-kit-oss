...
import { Alert, FlatList, Keyboard, Modal, Pressable, TextInput, View } from 'react-native';
...
const ServiceVariantCreator: React.FC<ServiceVariantCreatorProps> = ({ hasStock }) => {
    ...
    return (
        <>
            <View
                className={cn(
                    'mt-2 mb-2 overflow-hidden rounded-xl border-neutral-400',
                    options.length > 0 ? 'border' : '',
                )}
            >
                    ...
                    >
                        ...
                        <View className="mt-1 flex-row flex-wrap gap-1">
                            {option.values.map((value, i) => (
                                <View key={i} className="rounded-lg bg-gray-200 px-3 py-1 text-base dark:bg-gray-700">
            ...
            {variants.length > 0 && (
                <View className="mt-4">
                    <Text className="mt-0 mb-2 text-2xl font-medium dark:text-white">Service Packages</Text>
                    ...
                    <View className="bg-background w-full flex-1">
                        ...
                        <View className="mt-8 flex-1">
                            <View className="w-full px-4">
                                <Text className="text-2xl font-medium">Option name</Text>
                                <Text className="mb-4 w-full text-base">Package type, delivery time, revisions</Text>
                                <Input
                                    label="Name"
                                    value={currentOption.name}
                                    onChangeText={(text) => setCurrentOption({ ...currentOption, name: text })}
                                />
                                <Text className="mt-8 text-2xl font-medium">Values</Text>
                                <Text className="text-muted-foreground w-full text-base">
                                ...
                                <FlatList
                                    ...
                                    ListFooterComponent={
                                        ...
                                        >
                                            <Icon name="Plus" size={20} />
                                            <Text className="ml-2">Add value</Text>
                                        </Pressable>
                                    }
                                />
                            </View>
