...
export const MultipleImagePicker: React.FC<MultipleImagePickerProps> = ({ onImageSelect, hasMainImage = true }) => {
    ...
    return (
        <>
            <Text className="mb-2 text-base dark:text-white">Images</Text>
            <CardScroller>
                {mainImage ? (
                    <View className="relative">
                        ...
                        <Pressable
                            ...
                            className="dark:bg-dark-secondary absolute top-2 right-2 h-7 w-7 items-center justify-center rounded-lg bg-white"
                        >
                    ...
                    hasMainImage && (
                        ...
                        >
                            ...
                            <Text className="text-foreground absolute bottom-4 w-full text-center text-sm">
                                Main photo
                            </Text>
                        </Pressable>
                    )
                            ...
                            {image ? (
                                <>
                                    ...
                                    <Pressable
                                        ...
                                        className="absolute top-2 right-2 h-7 w-7 items-center justify-center rounded-lg bg-white"
                                    >
                                        <Icon name="Trash2" size={18} />
                                    </Pressable>
                                </>
