...
import { ImageBackground, Platform, StyleSheet, TouchableOpacity, View, ViewStyle } from 'react-native';
...
const CustomCard: React.FC<CustomCardProps> = ({
    ...
    const renderCardContent = () => {
        ...
        const content = backgroundImage ? (
            <View className={cn('overflow-visible', getRoundedClass(), getShadowClass(), className)}>
                <ImageBackground
                    className={cn(getRoundedClass(), 'relative w-full overflow-hidden')}
                ...
                >
                    {overlayOpacity > 0 && (
                        <View
                            className={cn(getPaddingClass(), 'absolute inset-0')}
                            style={{
