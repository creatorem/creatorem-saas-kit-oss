...
export const Chip = ({
    ...
    const renderLeftContent = () => {
        ...
        if (icon) {
            return (
                <Icon
                    ...
                    color={iconColor || (isChipSelected ? colors['--color-opposite'] : colors['--color-opposite'])}
                    className="mr-2 -ml-1"
                />
            );
        }
        ...
        if (image) {
            return (
                <Image
                    className="mr-2 -ml-2 rounded-lg"
                    source={image}
                    style={{
        ...
        <>
            <View className="flex-row items-center">
                ...
                <Text
                    className={cn(
                        `text-${textSizeClass}`,
                        isChipSelected ? 'text-white' : 'text-gray-700 dark:text-white',
                    )}
                >
                    {label}
                </Text>
        ...
        <View className={className}>
            <View
                className={cn(
                    ...
                    isChipSelected ? 'bg-primary' : 'bg-secondary',
                )}
            >
                {children}
            </View>
