...
export * from '../lib/time-picker-utils';
...
const TimePickerInput = React.forwardRef<HTMLInputElement, TimePickerInputProps>(
    (
        ...
        const calculateNewValue = useCallback(
            ...
            [picker, flag, calculatedValue, prevIntKey],
        );
        ...
        const handleKeyDown = useCallback(
            ...
            [calculatedValue, picker, flag, date, setDate, period, onRightFocus, onLeftFocus, calculateNewValue],
        );
