...
export function Heading({
    ...
    switch (level) {
        ...
        case 5:
            return (
                <h5 className={cn('font-heading scroll-m-20 text-base font-medium lg:text-lg', className)}>
                    {children}
                </h5>
            );
        case 6:
            return <h6 className={cn('font-heading scroll-m-20 text-base font-medium', className)}>{children}</h6>;
