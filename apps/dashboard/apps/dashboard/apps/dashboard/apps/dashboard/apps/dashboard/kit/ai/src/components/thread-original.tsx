    ...
    return (
        <LazyMotion features={domAnimation}>
            <MotionConfig reducedMotion="user">
                ...
                >
                    <ThreadPrimitive.Viewport className="aui-thread-viewport relative flex flex-1 flex-col overflow-x-auto overflow-y-scroll bg-amber-100 px-4">
...
const ThreadSuggestions: FC = () => {
    ...
    const suggestions = [
        {
            title: t('suggestionWeatherTitle'),
            label: t('suggestionWeatherLabel'),
            action: t('suggestionWeatherAction'),
        },
        {
            title: t('suggestionReactTitle'),
            label: t('suggestionReactLabel'),
            action: t('suggestionReactAction'),
        },
        {
            title: t('suggestionSqlTitle'),
            label: t('suggestionSqlLabel'),
            action: t('suggestionSqlAction'),
        },
        {
            title: t('suggestionMealTitle'),
            label: t('suggestionMealLabel'),
            action: t('suggestionMealAction'),
        },
    ];
    ...
    return (
        ...
        >
            <ActionBarPrimitive.Copy asChild>
                <Button aria-label={t('copyMessage')}>
            ...
            <ActionBarPrimitive.Reload asChild>
                <Button aria-label={t('refreshMessage')}>
                    <RefreshCwIcon />
                </Button>
    ...
    return (
        ...
        >
            <ActionBarPrimitive.Edit asChild>
                <Button aria-label={t('editMessageAction')} className="aui-user-action-edit p-4">
                    <PencilIcon />
                </Button>
    ...
    return (
        ...
        >
            <BranchPickerPrimitive.Previous asChild>
                <Button aria-label={t('previousAction')}>
                    <ChevronLeftIcon />
                </Button>
            ...
            <BranchPickerPrimitive.Next asChild>
                <Button aria-label={t('nextAction')}>
                    <ChevronRightIcon />
                </Button>
