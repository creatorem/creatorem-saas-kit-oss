/**
 * Tailwind v4 version @url https://ui.shadcn.com/docs/components/input-group
 * Changes:
 * - export and create the inputGroupClassName constant
 * - export the inputGroupAddonVariants
 * - submit the closest input type="submit" button when enter is pressed without shift key in the textarea
 */
