# Creatorem Agent Rules (Generic Adapter)

Use this file for coding agents that do not support AGENTS/CLAUDE/Cursor specific formats.
Generated from `docs/agent-rules/creatorem-agent-rules.contract.v1.json`.
